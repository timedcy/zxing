...
public class Detector {
    ...
    public final DetectorResult detectTimedcy(Map<DecodeHintType, ?> hints) throws NotFoundException, FormatException {
        resultPointCallback = hints == null ? null : (ResultPointCallback) hints.get(DecodeHintType.NEED_RESULT_POINT_CALLBACK);
        FinderPatternFinder finder = new FinderPatternFinder(image, resultPointCallback);
        FinderPatternInfo info = finder.findTimedcy(hints);
        return processFinderPatternInfo(info);
    }
    ...
    /**
     * <p>
     * Estimates module size based on two finder patterns -- it uses {@link #sizeOfBlackWhiteBlackRunBothWays(int, int, int, int)} to figure the width of each,
    ...
    /**
     * <p>
     * This method traces a line from a point in the image, in the direction towards another point. It begins in a black region, and keeps going until it finds
     * white, then black, then white again. It reports the distance from the start to this point.
     * </p>
     * 
     * <p>
